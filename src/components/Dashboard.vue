    ...
    <section v-if="user && user.role === 'patient'" class="section">
        ...
        <div class="card  mx-4">
            <div class="card-body">
                <ul class="list-group list-group-flush">
                    <li class="list-group-item">
                        <router-link to="/appointments" class="btn btn-link">Book Appointments</router-link>
                    </li>
                    <li class="list-group-item">
                        <router-link to="/records" class="btn btn-link">View Medical Records</router-link>
                    </li>
                </ul>
            </div>
        </div>
